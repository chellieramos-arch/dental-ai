...
def _select_relevant_images(candidates, question, answer_text, max_keep=5):
    ...
    content = [{
        ...
        "text": (
            ...
            "or a step-by-step figure. The test: would an instructor put this exact "
            "figure in a handout answering THIS question?\n\n"
            "REJECT an image if it is:\n"
            "- A charting/record-keeping graphic: an odontogram, perio chart, tooth-"
            "numbering grid, or treatment-planning chart. These track WHICH teeth get "
            "treatment for a specific patient — they don't show HOW a procedure is done. "
            "Even if the question is about crowns and the chart shows planned crowns, "
            "it teaches nothing about the procedure. Keep one ONLY if the question is "
            "itself about charting, record-keeping, or treatment planning/sequencing.\n"

...
def _select_relevant_images(candidates, question, answer_text, max_keep=5):
    ...
    content = [{
        ...
        "text": (
            ...
            "Below are candidate images pulled from their course materials.\n\n"
            "First, identify the SUBJECT of the question — the specific procedure, "
            "technique, anatomy, or concept the student is asking about (e.g. for "
            "'how do I prep tooth #19 for a crown' the subject is CROWN PREPARATION "
            "TECHNIQUE: reduction, finish lines, taper, prepped teeth).\n\n"
            "Then look at the ACTUAL VISUAL CONTENT of each image and KEEP ONLY images "
            "that directly DEPICT that subject — the procedure being performed or its "
            "result, the anatomy in question, or a step-by-step figure of it. The test: "
            "does this image visually teach the thing the student asked how to do or "
            "understand?\n\n"
            "REJECT everything that is merely topic-adjacent — related to the same "
            "tooth, appointment, or course unit without depicting the subject itself. "
            "Common traps:\n"
            "- Record-keeping graphics (odontograms, perio charts, treatment-planning "
            "grids): they may SHOW crowns or the asked-about tooth, but they document "
            "a patient's plan; they don't depict the procedure. Reject unless the "
            "subject IS charting/planning.\n"
            ...
            "no embedded picture was found on that page; keep one ONLY if the page is "
            "genuinely a figure depicting the subject, not typed content.\n"
            "- Cover pages, logos, decorative images, or figures of a different "
            "procedure/anatomy than asked about.\n\n"
            "When in doubt, reject — showing nothing is better than showing something "
            "that makes the student second-guess a correct answer.\n\n"
            f"QUESTION: {question}\n\n"
